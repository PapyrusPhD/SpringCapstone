...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private JwtEnrolleeDetailService jwtEnrolleeDetailService;
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(jwtEnrolleeDetailService).passwordEncoder(passwordEncoder());
    }
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.cors().and().csrf().disable()
                ...
                .antMatchers("/enrollee/login").permitAll()
                .antMatchers("/enrollee/register").permitAll()
